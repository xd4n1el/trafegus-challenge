...
import { Plus, Car, ShieldCheck, Wrench, Users, Map } from 'lucide-react';
import { Helmet } from 'react-helmet-async';
import { setDocumentTitle } from '@/utils/browser';

export const VehiclesPage = (): ReactElement => {
  const navigate = useNavigate();

  const documentTitle = 'Trafegus - Veículos';
          ...
          <div className="w-full h-full max-w-6xl mx-auto flex flex-col justify-center">
            <div className="flex flex-col gap-4 bg-gray-800 rounded-xl p-6 border border-gray-700 shadow-xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                ...
                <div className="bg-gray-800 rounded-xl p-4 border border-gray-700">
                  <div className="flex items-center justify-between mb-2">
                    <p className="text-gray-400 text-sm">Veículos Ativos</p>
                ...
                <div className="bg-gray-800 rounded-xl p-4 border border-gray-700">
                  <div className="flex items-center justify-between mb-2">
                    <p className="text-gray-400 text-sm">Veículos Inativos</p>
